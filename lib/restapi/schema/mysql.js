...
mysql.prototype.getSchema = function() {
...
mysql.prototype.getAllTableSchema = function(queries, data) {
  var deferred = Q.defer();
...
mysql.prototype.getTableSchema = function(queries, database, table) {
  var deferred = Q.defer();
...
mysql.prototype.execQuery = function(query, args) {
  var deferred = Q.defer();
