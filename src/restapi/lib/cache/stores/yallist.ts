...
export class Yallist {
  ...
  public forEachReverse(fn: Function, thisp?: any) {
    thisp = thisp || this;
    let i: number;
    let walker: any;
  ...
  public map(fn: Function, thisp?: any) {
    thisp = thisp || this;
  ...
  public mapReverse(fn: Function, thisp?: any) {
    thisp = thisp || this;
    const res = new Yallist();
  ...
  public reduce(fn: Function, initial?: any) {
    let acc: any;
  ...
  public reduceReverse(fn: Function, initial?: any) {
    let acc: any;
  ...
  public sliceReverse(from?: number, to?: number) {
    to = to || this.length;
    if (to < 0) {
      to += this.length;
    }
...
function push(self: Yallist, item: any) {
...
function unshift(self: Yallist, item: any) {
...
export class Node {
  ...
  constructor(value: any, prev: any, next: any, list: Yallist) {
    this.list = list;
    this.value = value;
