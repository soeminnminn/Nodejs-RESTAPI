...
class Mime {
   ...
   */
  public charsets = new class {
    constructor() {
    }

    public lookup(mimeType: string, fallback: string): string {
   ...
   */
  public lookup(path: string, fallback: string = undefined): string {
